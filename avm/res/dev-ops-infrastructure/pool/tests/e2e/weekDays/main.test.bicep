...
metadata name = 'Week Days Schema'
metadata description = 'This instance deploys the module using an Week Days Scheme for the manual scaling prediction configuration.'
